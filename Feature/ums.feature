...
Feature: Login the UMS
  ...
  Scenario Outline: Reports
    ...
    Examples: 
      ...
      | venkatesh.udaru@ikcontech.com | praveenreddy.g@ikcontech.com | sasirekha.t@ikcontech.com | Test@1234 | Venkatesh | Praveen | Samyuktha | Information Technology | Human Resource | Finance | High | Medium | Low | Yet to start | Inprogress | Completed | Organizational | External | Risk | Project Management | Technical |
