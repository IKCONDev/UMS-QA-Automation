...
Feature: Login the UMS
  ...
  #Then add the Role Menu Items "<RN1>" "<PnN>"
  #Then add the Role Menu Items "<RN2>" "<PnN>"
  #Then add the Role Menu Items "<RN3>" "<PnN>"
  #Then add the Role Menu Items "<RN4>" "<PnN>"
  #Then add the Role Menu Items "<RN5>" "<PnN>"
...
#
    #Examples: 
      ...
      #| venkatesh.udaru@ikcontech.com | Test@12   | success |
