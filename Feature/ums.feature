...
Feature: Login the UMS
  ...
  Scenario Outline: LoginUMS
    ...
    Examples: 
      ...
      | High | Medium | Low | venkatesh.udaru@ikcontech.com | praveenreddy.g@ikcontech.com  | samyuktha.r@ikcontech.com     | Test@1234 | UMS Automation    | qa server setup | Qa server installation | Devops operations | Devops operations | Scrum Status | scrum status report | Regression testing | Dialy Regression testing | Developing the Operation | Developing the Operation of Product | Developmet Update | Development update today         | Monkey testing     | Monkey testing status    | Community Management | Software Development | Quality Assurance |
      | High | Medium | Low | praveenreddy.g@ikcontech.com  | venkatesh.udaru@ikcontech.com | samyuktha.r@ikcontech.com     | Test@123 | Automation of UMS | qa server setup | Qa server installation | Devops operations | Devops operations | Scrum Status | scrum status report | Sanity testing     | Initial Sanity testing   | Updating the Developing  | Updating the Developing of Product  | Bug Update        | Bug Update today                 | Regression testing | Dialy Regression testing | Community Management | Software Development | Quality Assurance |
      | High | Medium | Low | samyuktha.r@ikcontech.com     | praveenreddy.g@ikcontech.com  | venkatesh.udaru@ikcontech.com | Test@123 | Scrum Meeting     | qa server setup | Qa server installation | Devops operations | Devops operations | Scrum Status | scrum status report | Smoke testing      | Initial Smoke testing     | Checking the Developing  | Checking the Developing of Product  | Product Update    | Prdouct current completed update | Smoke testing      | Initial Smoke tesing     | Community Management | Software Development | Quality Assurance |
  ...
  Scenario Outline: Reports
    ...
    And view the reports "<d2>"
    And Task category "<c1>"
    And Task category "<c2>"
    And Task category "<c3>"
    And Task category Task Category summary "<c1>"
    Then user enter the profile icon button
    And user enter the logout

    Examples: 
      | UN                            | UN1                          | UN2                       | PW       | vn        | vn1     | d1                     | d2             | d3      | p1   | p2     | p3  | s1           | s2         | s3        | c1                   | c2                   | c3                |
      | venkatesh.udaru@ikcontech.com | praveenreddy.g@ikcontech.com | sasirekha.t@ikcontech.com | Test@1234 | Venkatesh | Praveen | Information Technology | Human Resource | Finance | High | Medium | Low | Yet to start | Inprogress | Completed | Community Management | Software Development | Quality Assurance |
  ...
  Scenario Outline: forgot password
    ...
    Examples: 
      ...
      | venkatesh.udaru@ikcontech.com | Test@1234   | success |
      | venkatesh.udaru@ikcontech.com | Test@123    | fail    |
